...
#define F_UNIDAD_TRADUCCION (CVOID | CCHAR | CINT | CFLOAT)
#define F_DECLARACIONES (CVOID | CCHAR | CINT | CFLOAT)
#define F_ESPECIFICADOR_TIPO (CVOID | CCHAR | CINT | CFLOAT)
#define F_ESPECIFICADOR_DECLARACION (CPAR_ABR | CASIGNAC | CCOR_ABR | CCOMA | CPYCOMA)
#define F_DEFINICION_FUNCION (CPAR_ABR)
#define F_DECLARACION_VARIABLE (CASIGNAC | CCOR_ABR | CCOMA | CPYCOMA)
#define F_LISTA_DECLARACIONES_PARAM (CVOID | CCHAR | CINT | CFLOAT)
#define F_DECLARACION_PARAMETRO (CVOID | CCHAR | CINT | CFLOAT)
#define F_DECLARADOR_INIT (CASIGNAC | CCOR_ABR)
#define F_LISTA_DECLARACIONES_INIT (CIDENT)
#define F_LISTA_INICIALIZADORES (CCONS_ENT | CCONS_FLO | CCONS_CAR)
#define F_LISTA_PROPOSICIONES PLACEHOLDER
#define F_LISTA_DECLARACIONES (CVOID | CCHAR | CINT | CFLOAT)
#define F_DECLARACION (CVOID | CCHAR | CINT | CFLOAT)
